...
var ProductService = /** @class */ (function () {
    function ProductService() {
        ...
        this.dataSource.getProducts().forEach(function (p) {
            return _this.products.push(p);
        });
    }
    //interface içindeki methodlar geldi
    ...
    ProductService.prototype.saveProduct = function (product) {
        if (product.id == 0 || product.id == null) {
            ...
            this.products.splice(index, 1, product); //index den bir sonraki elemanı siler sonra productı ekler
        }
    };
